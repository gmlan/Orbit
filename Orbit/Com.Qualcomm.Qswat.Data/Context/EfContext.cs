...
{
    /// <summary>
    /// context with Entity Framework. Acting as main unit of work.
    /// </summary>
    public class EfContext : DbContext, IDbContext
    {
        #region Ctor

        public EfContext() : base("Orbit")
        {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Conventions.Add(new FunctionsConvention<EfContext>("dbo"));
        ...
        {
            return Database.SqlQuery(type, sql, parameters);
        }
        ...
        [DbFunction("CodeFirstDatabaseSchema", "DateDifference")]
        public static int DateDifference(DateTime startDate, DateTime endDate, bool exludeSaturday = false, bool excludeSunday = false,
            int minDay = 0)
        {
